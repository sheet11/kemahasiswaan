    ...
    <section class="content-header">
    	<div class="container-fluid" style="margin:10px;">	
    		<table style="width:100%;">
	            ...
	            <tr><td width="20%">
		                     <a href="03_tambah_surat_keterangan_masih_kuliah.php" class="btn btn-info">Tambah Surat</a> 
		                </td> 
        ...
        <table style="width:100%;" class="table table-bordered">    
           <tr class="info">
							<th>No.</th><th>Nama Mahasiswa</th><th>NIM</th><th>Jurusan</th><th>Tingkat</th><th>Tahun Akademik</th><th>Status</th><th width="5%">Aksi</th>
						</tr>
            <?php 
                ...
                <tr>
                    ...
                    <td>";
										...
										echo"</td>";
											...
											echo"<td>
                        <a href='03_edit_surat_keterangan_masih_kuliah.php?id_surat_keterangan_masih_kuliah=$a[id_surat_keterangan_masih_kuliah]' class='btn btn-info'>
                ...
                <tr>
                    ...
                    <td>";
										...
										echo"</td>";
											...
											echo"<td>
                        <a href='03_edit_surat_keterangan_masih_kuliah.php?id_surat_keterangan_masih_kuliah=$a[id_surat_keterangan_masih_kuliah]&halaman=$_GET[halaman]' class='btn btn-info'>
                            <span class='glyphicon glyphicon-pencil' aria-hidden='true'></span>
                        </a> 
                    </td>
                </tr>";
