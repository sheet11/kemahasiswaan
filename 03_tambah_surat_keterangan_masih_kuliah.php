    ...
    <section class="content-header">
			...
			<form method="post" action="" enctype="multipart/form-data">	
				<table style="width:100%" class="table table-basic">
					...
					<tr>
						<td>NIM Mahasiswa</td> 
						<td width="2%">:</td>
						<td colspan="2"><input type="text" placeholder="NIM Mahasiswa" name="nim_mahasiswa" required="yes"class="form-control" value="<?=$u['username'];?>"></td> 
					</tr>
					...
					<tr>
						...
						<td width="2%">:</td>
						<td><input type="text" placeholder="Nama Orang Tua " name="nama_orang_tua" required="yes" class="form-control"></td>
					</tr>
					...
					<tr>
						...
						<td width="2%">:</td>
						<td><input type="text" placeholder="Pangkat / Golongan " required="yes" name="pangkat" class="form-control" ></td>
					</tr>

					<tr>
						<td>Instansi</td> 
						<td width="2%">:</td>
						<td><input type="text" placeholder="Nama Instansi" name="instansi" required="yes" class="form-control"></td>
					</tr>
		...
		<?php
			if(isset($_POST['submit']))
				...
				$query=mysqli_query($kon,"insert into tb_surat_keterangan_masih_kuliah(nama_mahasiswa, nim_mahasiswa, keperluan, tingkat,semester, tahun_akademik, nama_orang_tua, nip, pekerjaan, pangkat, instansi, jurusan, prodi, tanggal_cetak)
