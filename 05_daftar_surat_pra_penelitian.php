...
<div class="container-fluid" style="margin:10px;">
    ...
    <div class="header-bar">
        <h4>Daftar Surat Pra Penelitian</h4>
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <?php if ($sp == 'Menunggu' || $sp == 'Perlu_Revisi' || $sp == 'Telah_Direvisi'): ?>
                    <a href="05_edit_surat_pra_penelitian.php?id_surat_pra_penelitian=<?php echo $id; ?>&halaman=<?php echo $hal; ?>"
    ...
    <?php
    $jmldata     = mysqli_num_rows(mysqli_query($kon, "SELECT * FROM tb_surat_pra_penelitian WHERE nim_mahasiswa='$nim'"));
