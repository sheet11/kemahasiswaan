...
<aside class="right-side">
    <section class="content-header">
    	<div class="container-fluid" style="margin:10px;">	
    		<table style="width:100%;">
	            ...
	            <tr><td width="20%">
		                     <a href="05_tambah_surat_pra_penelitian.php" class="btn btn-info">Tambah Surat</a> 
		                </td> 
        ...
        <table style="width:100%;" class="table table-bordered">    
            <tr class="info">
                <th>No.</th><th>Nama Mahasiswa</th><th>NIM</th><th>Prodi</th><th>Judul</th><th>Tujuan</th>Keterangan<th>Status</th><th width="5%">Aksi</th>
            </tr>
            <?php 
                ...
                if(isset($_POST['submit'])){
                    $cariid = $_POST['cariid'];
                    $cari = $_POST['cari'];
                    $query=mysql_query("select * from tb_surat_pra_penelitian where $cariid = '$cari' or $cariid = '0' "); 
                    $i = $posisi+1;      
                ...
                <tr>
                    ...
                    <td>";
										...
										echo"</td>";
											...
											echo"<td>
                        <a href='05_edit_surat_pra_penelitian.php?id_surat_pra_penelitian=$a[id_surat_pra_penelitian]' class='btn btn-info'>
            ...
            echo"
                ...
                $i++;
                    ...
                    $query=mysql_query("select * from tb_surat_pra_penelitian order by id_surat_pra_penelitian desc  LIMIT $posisi,$batas");
                ...
                <tr>
                    ...
                    <td>";
										...
										echo"</td>";
											...
											echo"<td>
                        <a href='05_edit_surat_pra_penelitian.php?id_surat_pra_penelitian=$a[id_surat_pra_penelitian]&halaman=$_GET[halaman]' class='btn btn-info'>
                            <span class='glyphicon glyphicon-pencil' aria-hidden='true'></span>
                        </a> 
                    </td>
                </tr>";
    ...
    $jmldata = mysql_num_rows(mysql_query("SELECT * FROM tb_surat_pra_penelitian "));
