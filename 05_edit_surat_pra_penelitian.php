...
$id = (int)$_GET['id_surat_pra_penelitian'];
...
<div class="container-fluid" style="margin:10px;">
    ...
    <form method="post" action="05_prosesedit_surat_pra_penelitian.php">
        ...
        <table width="100%" border="0" class="table table-hover">
            <tr>
                <td class="info" colspan="3"><b>Edit Surat Pra Penelitian</b></td>
            </tr>

            <tr>
                <td width="15%">Nama Mahasiswa</td>
                <td width="2%">:</td>
                <td><input type="text" name="nama_mahasiswa" class="form-control"
            ...
            <tr>
                <td>Lokasi</td>
                <td>:</td>
                <td><textarea name="lokasi" class="form-control"><?php echo htmlspecialchars($a['lokasi']); ?></textarea></td>
            </tr>
