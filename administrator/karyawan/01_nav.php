            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
	                    ...
	                    <li class="treeview">
	                        <a href=""><i class="fa fa-desktop"></i>Laporan<span class="pull-right-container">
                                  <i class="fa fa-angle-left pull-right"></i></a>
	                        <ul class="treeview-menu">
	                        	<li> 
	                                <a href="10_laporan_pra_penelitian.php"><i class="fa fa-desktop"></i> Surat Pra Penelitian</a>
	                            </li>
	                            <li> 
	                                <a href="11_laporan_surat_penelitian.php"><i class="fa fa-desktop "></i> Surat Penelitian</a>
	                            </li>
	                            <li> 
	                                <a href="12_laporan_surat_keterangan_masih_kuliah.php"><i class="fa fa-desktop"></i> Surat Keterangan Masih Kuliah</a>
	                            </li>
	                        </ul>
	                    </li> 

                        <li class="treeview">
                            <a href=""><i class="fa fa-desktop"></i>Pengaturan<span class="pull-right-container">
                                  <i class="fa fa-angle-left pull-right"></i></a>
                            <ul class="treeview-menu">
                                <li> 
