...
<div class="toolbar">
    ...
    <?php if ($level == 'karyawan' || $level == 'administrator'): ?>
        ...
        <?php if ($sp == 'Menunggu' || $sp == 'Telah_Direvisi'): ?>
            <a href="proses_karyawan.php?aksi=setujui&jenis=masih_kuliah&id=<?php echo $id; ?>&return=<?php echo urlencode($return); ?>"
               onclick="return confirm('Setujui dan teruskan ke Wadir?')" class="btn btn-success btn-sm">
                <i class="fa fa-check"></i> Setujui ke Wadir
            </a>
            <a href="proses_karyawan.php?aksi=tolak&jenis=masih_kuliah&id=<?php echo $id; ?>&return=<?php echo urlencode($return); ?>"
               class="btn btn-warning btn-sm">
                <i class="fa fa-times"></i> Tolak
            </a>
        <?php elseif ($sp == 'Disetujui'): ?>
            <a href="03_cetak_surat_keterangan_masih_kuliah.php?id_surat_keterangan_masih_kuliah=<?php echo $id; ?>"
...
<div class="surat-wrapper">
    <table border="0" width="100%" cellpadding="0">
        <tr>
            <td colspan="3" align="center" style="font-size:14.0pt;"><b>SURAT PERNYATAAN MASIH KULIAH</b></td>
        </tr>
        <tr>
