        ...
        <div class="container-fluid" style="margin:10px;"> 
			<form method="post" action="" enctype="multipart/form-data">		
				<table style="width:100%;" class="table table-hover" >
					<tr>
						<td colspan="2"><label>Laporan Surat Keterangan Masih Kuliah</label></td>
					</tr>
			...
			if(isset($_POST['submit'])){
				...
				$query = mysqli_query($kon, "SELECT * FROM tb_surat_keterangan_masih_kuliah WHERE tanggal_cetak BETWEEN '$_POST[tanggal_masuk_awal]' AND '$_POST[tanggal_masuk_akhir]'");
