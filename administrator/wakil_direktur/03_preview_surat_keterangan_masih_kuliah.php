...
$a  = mysqli_fetch_array(mysqli_query($kon, "SELECT * FROM tb_surat_keterangan_masih_kuliah WHERE id_surat_keterangan_masih_kuliah='$id'"));
...
<?php
$status_map = [
    'Disetujui_Resepsionis' => ['s-menunggu',  '<i class="fa fa-clock-o"></i> Status: Menunggu Persetujuan Wadir — Sudah divalidasi oleh Karyawan'],
    'Disetujui'             => ['s-disetujui', '<i class="fa fa-check-circle"></i> Status: Disetujui — Tanggal: ' . $a['tanggal_persetujuan']],
    'Ditolak_Wadir'         => ['s-ditolak',   '<i class="fa fa-times-circle"></i> Status: Ditolak Wadir — Mahasiswa diminta mengajukan surat baru' . (!empty($a['catatan_penolakan']) ? ' | Catatan: '.htmlspecialchars($a['catatan_penolakan']) : '')],
];
...
<div class="surat-wrapper">
    <table border="0" width="100%" cellpadding="0">
        <tr><td colspan="3" align="center" style="font-size:14.0pt;"><b>SURAT PERNYATAAN MASIH KULIAH</b></td></tr>
        <tr><td colspan="3" align="center">NOMOR : KH.06.01/F.XXIII.1/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/<?php echo date('Y'); ?></td></tr>
    </table>
    ...
    <table border="0" width="100%">
        <tr><td colspan="3" style="text-align:justify;">Adalah benar mahasiswa Program Studi <?php echo $a['prodi']; ?> Jurusan <?php echo $a['jurusan']; ?> Poltekkes Kemenkes Bengkulu</td></tr>
        <tr><td colspan="3" style="text-align:justify;">Demikian Surat Keterangan ini dibuat dengan sesungguhnya agar dapat digunakan sebagaimana mestinya.</td></tr>
        <tr><td colspan="3">&nbsp;</td></tr>
        <tr><td width="40%">&nbsp;</td><td>&nbsp;</td><td style="padding-left:80px;">Bengkulu, <?php echo $tanggal2; ?></td></tr>
        <tr><td>&nbsp;</td><td>&nbsp;</td><td style="padding-left:80px;">Wakil Direktur I Bidang Akademik,</td></tr>
        <tr><td colspan="3">&nbsp;</td></tr><tr><td colspan="3">&nbsp;</td></tr><tr><td colspan="3">&nbsp;</td></tr>
        <tr><td>&nbsp;</td><td>&nbsp;</td><td style="padding-left:80px;"><b><u>Septiyanti, S.Kep, Ners, M.Pd</u></b></td></tr>
        <tr><td>&nbsp;</td><td>&nbsp;</td><td style="padding-left:80px;">NIP. 197409161997032001</td></tr>
    </table>
</div>
