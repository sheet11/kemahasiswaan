...
<aside class="right-side">
    <section class="content-header">
        <h1>Persetujuan <small>Surat Penelitian</small></h1>
        <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Surat Penelitian</li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
                ...
                $query  = mysqli_query($kon, "SELECT * FROM tb_surat_penelitian $where ORDER BY id_surat_penelitian DESC LIMIT $posisi,$batas");
                $i      = $posisi + 1;
                ...
                <div class="search-bar-wrap">
                    <div class="input-group">
                        ...
                        <input type="text" id="keyword_pen" class="form-control" placeholder="Cari nama, NIM, jurusan, judul..." autocomplete="off">
                        <span class="input-group-btn">
                            <button class="btn btn-default" id="btn_reset_pen" type="button"><i class="fa fa-times"></i></button>
                        </span>
                    </div>
                    <small id="info_pen" class="text-muted"></small>
                    <span id="loading_pen" style="display:none; color:#888;"><i class="fa fa-spinner fa-spin"></i></span>
                </div>
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        ?>
                            <tr id="row-<?php echo $id; ?>" <?php echo $bisa_cb ? 'class="row-menunggu" data-id="'.$id.'"' : ''; ?>>
                                ...
                                <td class="col-judul"><?php echo substr($a['judul_kti'], 0, 60) . (strlen($a['judul_kti']) > 60 ? '...' : ''); ?></td>
                                ...
                                <td class="text-center">
                                    <a href="04_preview_surat_penelitian.php?id_surat_penelitian=<?php echo $id; ?>&return=04_persetujuan_surat_penelitian.php"
                ...
                <?php
                $jmldata    = mysqli_num_rows(mysqli_query($kon,"SELECT * FROM tb_surat_penelitian $where"));
...
(function () {
    ...
    var tbody = document.getElementById('tbody_pen');
    if (tbody) {
    ...
    if (btnKonfirmasi) {
        btnKonfirmasi.addEventListener('click', function() {
            ...
            xhr.send('ids=' + encodeURIComponent(JSON.stringify(ids)) + '&jenis=penelitian');
        });
    }
}());
...
(function () {
    ...
    function renderJudul(j){if(!j)return '';var e=escHtml(j);return e.length>60?e.substring(0,60)+'...':e;}
    ...
    function renderAksi(r){
        var id=r.id_surat_penelitian;
        return "<a href='04_preview_surat_penelitian.php?id_surat_penelitian="+id+"&return=04_persetujuan_surat_penelitian.php' class='btn btn-primary btn-xs btn-aksi'><i class='fa fa-eye'></i> Lihat</a>";
    }
    ...
    function doSearch(kw){
        ...
        var xhr=new XMLHttpRequest();
        xhr.open('GET','../karyawan/ajax_search_surat.php?tabel=penelitian&keyword='+encodeURIComponent(kw),true);
        xhr.onreadystatechange=function(){
            if(xhr.readyState!==4)return;
            ...
            for(var i=0;i<rows.length;i++){
                ...
                html+="<tr id='row-"+r.id_surat_penelitian+"'"+(isMenunggu?" class='row-menunggu' data-id='"+r.id_surat_penelitian+"'":"")+">";
                html+="<td>"+(i+1)+"</td>";
                html+="<td class='col-nama'>"+escHtml(r.nama_mahasiswa)+"</td>";
                html+="<td>"+escHtml(r.nim_mahasiswa)+"</td>";
                html+="<td>"+escHtml(r.jurusan)+"</td>";
                html+="<td class='col-judul'>"+renderJudul(r.judul_kti)+"</td>";
