                ...
                <table class="table table-bordered table-striped table-hover">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <?php $id_s = $a['id_surat_penelitian']; ?>
                                <?php if ($sp == 'Menunggu'): ?>
                                    <a href="proses_persetujuan.php?aksi=setujui&jenis=penelitian&id=<?php echo $id_s; ?>&return=04_persetujuan_surat_penelitian.php"
                                    ...
                                    <a href="proses_persetujuan.php?aksi=tolak&jenis=penelitian&id=<?php echo $id_s; ?>&return=04_persetujuan_surat_penelitian.php"
