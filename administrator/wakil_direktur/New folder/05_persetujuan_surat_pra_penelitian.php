                ...
                <table class="table table-bordered table-striped table-hover">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <?php $id_s = $a['id_surat_pra_penelitian']; ?>
                                <?php if ($sp == 'Menunggu'): ?>
                                    <a href="proses_persetujuan.php?aksi=setujui&jenis=pra_penelitian&id=<?php echo $id_s; ?>&return=05_persetujuan_surat_pra_penelitian.php"
                                    ...
                                    <a href="proses_persetujuan.php?aksi=tolak&jenis=pra_penelitian&id=<?php echo $id_s; ?>&return=05_persetujuan_surat_pra_penelitian.php"
